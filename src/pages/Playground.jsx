...
const formatGuide = [
  { format: 'PNG', bestFor: 'UI screenshots, text-heavy pages, anything needing transparency', tradeoff: 'Larger file size than JPG or WebP for photo-heavy pages', icon: '\u{1F5BB}' },
        ...
        <div className="container">
          ...
          <div className="pg-layout">
            ...
            <div className="pg-controls">
              ...
              {/* Delay */}
              <div className="pg-control-group pg-premium">
                <label className="pg-label">Custom Delay (ms) â€” {delay}ms</label>
                <input
                  className="pg-slider"
                  type="range"
                  min="0"
          ...
          <div className="pg-output-guide">
            ...
            <div className="pg-output-grid">
              <div className="pg-output-card">
                ...
                <p><strong>Trade-off:</strong> No metadata â€” you only get the raw file back</p>
              </div>
              <div className="pg-output-card">
                <h4>JSON</h4>

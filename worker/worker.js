  ...
  async fetch(request, env, ctx) {
    ...
    if (path === '/api/screenshot' && request.method === 'GET') {
      ...
      try {
        ...
        if (!resp2.ok) return jsonError(500, 'Screenshot failed. The URLàÅµ•ù°–ÅπΩ–ÅâîÅÖççïÕÕ•â±î∏ú§(ÄÄÄÄÄÄÄÅŸÖ»Å•µÖùï	’ôôï»ÄÙÅÖ›Ö•–Å…ïÕ¿»πÖ……ÖÂ	’ôôï»†§(ÄÄÄÄÄÄÄÅ•òÄ°ïπÿπMI9M!=QL§ÅÏÅÖ›Ö•–ÅïπÿπMI9M!=QLπ¡’–°çÖç°ï-ï‰∞Å•µÖùï	’ôôï»∞ÅÏÅç’Õ—Ωµ5ï—ÖëÖ—ÑËÅÏÅ’…∞ËÅ¡Ö…ÖµÃπ’…∞ÅÒÄùç’Õ—Ωµ}°—µ∞ú∞Åç…ïÖ—ïêËÅπï‹ÅÖ—î†§π—Ω%M=M—…•πú†§ÅÙÅÙ§ÅÙ(ÄÄÄÄÄÄÄÅÖ›Ö•–Å±ΩùUÕÖùî°ïπÿ∞ÅÖ¡•-ï‰∞Å¡Ö…ÖµÃπ’…∞ÅÒÄùç’Õ—Ωµ}°—µ∞ú§(ÄÄÄÄÄÄÄÅŸÖ»Åç–»ÄÙÅ¡Ö…ÖµÃπôΩ…µÖ–ÄÙÙÙÄù¡ëòúÄ¸ÄùÖ¡¡±•çÖ—•Ω∏Ω¡ëòúÄËÄù•µÖùîºúÄ¨Å¡Ö…ÖµÃπôΩ…µÖ–(ÄÄÄÄÄÄÄÅ…ï—’…∏Åπï‹ÅIïÕ¡ΩπÕî°•µÖùï	’ôôï»∞ÅÏÅ°ïÖëï…ÃËÅÏÄùΩπ—ïπ–µQÂ¡îúËÅç–»∞Äù`µÖç°îúËÄù5%MLú∞ÄùççïÕÃµΩπ—…Ω∞µ±±Ω‹µ=…•ù•∏úËÄù°——¡ÃËºΩÕ°Ω—±ÂÖ¡§π•∏ú∞ÄùM—…•ç–µQ…ÖπÕ¡Ω…–µMïç’…•—‰úËÄùµÖ‡µÖùîÙÃƒ‘‘Ãÿ¿¿¿ÏÅ•πç±’ëïM’âΩµÖ•πÃú∞Äù`µΩπ—ïπ–µQÂ¡îµ=¡—•ΩπÃúËÄùπΩÕπ•ôòú∞Äù`µ…Öµîµ=¡—•ΩπÃúËÄù9dúÅÙÅÙ§(ÄÄÄÄÄÅÙÅçÖ—ç†Ä°î§ÅÏ(ÄÄÄÄÄÄÄÅ…ï—’…∏Å©ÕΩπ……Ω»†‘¿¿∞ÄùΩ’±êÅπΩ–Å…ïÖç†ÅÕç…ïïπÕ°Ω–ÅÕï…Ÿï»∏ÅQ…‰ÅÖùÖ•∏Å•∏ÅÑÅôï‹ÅÕïçΩπëÃ∏ú§(ÄÄÄÄÄÅÙ(ÄÄÄÅÙ((ÄÄÄÅ…ï—’…∏Å©ÕΩπ……Ω»†–¿–∞Äù9Ω–ÅôΩ’πê∏Å°ïç¨ÅëΩçÃÅÖ–Å°——¡ÃËºΩÕ°Ω—±ÂÖ¡§π•∏ΩëΩçÃú§(ÄÅÙ∞)Ù((